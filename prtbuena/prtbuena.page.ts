...
export class PrtbuenaPage implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    .duration(5000)
    .keyframes([
      { offset: 0, color: 'orange', transform: 'translate(-100%)', opacity: '1'},
      { offset: 0.5, color: '#00008B', transform: 'translate(100%)', opacity: '0.5'},
      { offset: 1, color: 'orange', transform: 'translate(-100%)', opacity: '1'}
    ]);
  anim.play();
    ...
    .duration(8000)
    .keyframes([
      { offset: 0, color: 'yellow', transform: 'scale(1)'},
      { offset: 0.5, color: 'orange', transform: 'scale(1.1)'},
      { offset: 1, color: 'yellow', transform: 'scale(1)'}
    ]);
  aniIniciar.play();
